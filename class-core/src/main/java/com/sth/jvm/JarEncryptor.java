...
import com.sth.jvm.util.ClassUtils;
...
public class JarEncryptor {
    ...
    static {
        ...
        aopMap.put("spring.code", "char[] c=${passchar};"
                + "is=com.maya.jvm.JarDecryptor.getInstance().decryptConfigFile(this.path,is,c);");
        ...
        aopMap.put("jfinal.code", "char[] c=${passchar};inputStream=com.maya.jvm.JarDecryptor.getInstance().decryptConfigFile(fileName,inputStream,c);");
...
//        });
    ...
    private List<String> encryptClass(List<File> classFiles) {
        ...
        classFiles.forEach(classFile -> {
           ...
           // Log.println("class"+className+"原始内容:"+Base64.getEncoder().encodeToString(bytes));
        ...
        Log.debug("HASH:"+Base64.getEncoder().encodeToString(StrUtils.toBytes(pchar)));
