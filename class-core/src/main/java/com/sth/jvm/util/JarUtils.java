...
public class JarUtils {
    ...
    public static void readJarFile(String jarAddress) {
        try{
            ...
            while (entries.hasMoreElements()) {
                ...
                if(!jarEntry.isDirectory()){ //是否为一个文件夹
                   ...
                   // System.out.println(new String(IoUtils.toBytes(jarFile.getInputStream(jarEntry))));
                }
            }
        }catch (Exception e){
   ...
   /* public static void main(String[] args) {
        JarUtils.readJarFile("/Users/joke/Desktop/my/class-protect/class-web/target/class-web-1.0.0-encrypted.jar");
    }*/
